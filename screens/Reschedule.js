    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.card}>
        <View style={styles.Drhead}>
          <Text style={styles.DrName}>Dr. {appointmentItem.doctor.name}</Text>
        </View>

        <View style={styles.Drinfo}>
          <View style={{padding: 10}}>
            <Image
              source={{uri: appointmentItem.doctor.picture}}
              style={styles.img}
            />
          </View>
          <View>
            <Text style={styles.SlotDate}>
              {appointmentItem.doctor.designation}
            </Text>
